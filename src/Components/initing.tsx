...
import { colorHooks, getColor } from "models/system/colors.model";
import { setTemp } from "@/reducers/Object/object.slice";
import { getSettingValue } from "@/reducers/Settings/settings.model";
import { allSections } from "@/data/pkg/table.def";
export const directions = {
  ip4: "local.ip4",
  htmlDev: "dev.html.hoverPosition",
};
...
export const userSections = allSections.filter(({ section }) => section == "user");
export const globalSections = allSections.filter(({ section }) => !section || section == "global");
//
