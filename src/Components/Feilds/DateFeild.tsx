import { Shortcut, tw } from "@/functions/react-utils";
...
export function DateFeild({ state, config = {}, id }: DateFeildProps) {
  const colorMerge = useColorMerge(),
    ...
    styleView = colorMerge("secondry.background", {
      borderColor: "borders",
    }),
    error = useCopyState(true),
    borderStyle = colorMerge(
      focused.get &&
        error.get && {
          borderColor: "primary",
        },
      focused.get &&
        !error.get && {
          borderColor: "credit.status.greate",
        },
    ),
    noProvidedMessage = getText("no provided");
  /*
   ******************************************************************************************************************************************************
   *                                                                                                                                                    *
   *                                                                                                                                                    *
