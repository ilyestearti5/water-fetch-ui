import { notifayHooks } from "models/system/notifications.model";
...
export function Notifications() {
  ...
  return (
    ...
    >
      <div
        className="notifay-top-view cursor-pointer flex justify-between items-center gap-2 p-3 group"
        onClick={() => {
          settingHooks.setOneFeild(notsVisibility, "value", !notes);
        }}
      >
        <h3 className="notifay-full-title text-lg uppercase font-bold">
