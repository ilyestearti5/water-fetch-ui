...
export declare function defineTable<T extends object, I extends keyof T, N extends string, A extends object, O extends GetOptinal<T> = any>(config: TableDefConfig<T, I, N, A>): {
    ...
    hooks: {
        ...
        getOneFeild<F extends keyof T>(recordId: EntityId, feild: F): ({ [K in keyof T]: T[K]; }[F] & ({} | null)) | undefined;
        setOneFeild<F extends keyof T>(id: EntityId, feild: F, value: T[F]): void;
        ...
        getOneFeilds<F extends keyof T>(id: EntityId, feilds: F[]): { [key in F]: T[F]; } | undefined;
        getAll(): T[];
