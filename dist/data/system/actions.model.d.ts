...
export declare const actionEntity: import("@reduxjs/toolkit").EntityAdapter<Action, import("@reduxjs/toolkit").EntityId>, actionSlice: import("@reduxjs/toolkit").Slice<import("@reduxjs/toolkit").EntityState<Action, import("@reduxjs/toolkit").EntityId> & {
    ...
    getOneFeild<F extends keyof Action>(recordId: import("@reduxjs/toolkit").EntityId, field: F): ({
        actionId: string;
        status: QueryStatus | "ready";
        args?: any;
        output?: any;
    }[F] & ({} | null)) | undefined;
    setOneFeild<F extends keyof Action>(id: import("@reduxjs/toolkit").EntityId, field: F, value: Action[F]): void;
    useOneFeild<F extends keyof Action>(recordeId: import("@reduxjs/toolkit").EntityId, field: F): {
        get: ({
            actionId: string;
            status: QueryStatus | "ready";
            args?: any;
    ...
    getOneFeilds<F extends keyof Action>(id: import("@reduxjs/toolkit").EntityId, fields: F[]): (F extends infer T extends keyof Action ? { [key in T]: Action[F]; } : never) | undefined;
    getAll(): Action[];
