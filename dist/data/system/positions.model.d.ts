...
export declare const positionsEntity: import("@reduxjs/toolkit").EntityAdapter<Positions, import("@reduxjs/toolkit").EntityId>, positionsSlice: import("@reduxjs/toolkit").Slice<import("@reduxjs/toolkit").EntityState<Positions, import("@reduxjs/toolkit").EntityId> & {
    ...
    getOneFeild<F extends keyof Positions>(recordId: import("@reduxjs/toolkit").EntityId, field: F): ({
        positionId: string;
        height?: number | undefined;
        width?: number | undefined;
        x?: number | undefined;
    ...
    setOneFeild<F extends keyof Positions>(id: import("@reduxjs/toolkit").EntityId, field: F, value: Positions[F]): void;
    useOneFeild<F extends keyof Positions>(recordeId: import("@reduxjs/toolkit").EntityId, field: F): {
        get: ({
            positionId: string;
            height?: number | undefined;
            width?: number | undefined;
    ...
    getOneFeilds<F extends keyof Positions>(id: import("@reduxjs/toolkit").EntityId, fields: F[]): (F extends infer T extends keyof Positions ? { [key in T]: Positions[F]; } : never) | undefined;
    getAll(): Positions[];
