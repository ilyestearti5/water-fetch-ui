...
export declare const slotHooks: {
    ...
    getOneFeild<F extends keyof SlotType>(recordId: import("@reduxjs/toolkit").EntityId, feild: F): ({
        slotId?: string;
        focused?: number | null;
        submited?: number | null;
        selected?: {
    ...
    setOneFeild<F extends keyof SlotType>(id: import("@reduxjs/toolkit").EntityId, feild: F, value: SlotType[F]): void;
    useOneFeild<F extends keyof SlotType>(recordeId: import("@reduxjs/toolkit").EntityId, feild: F): {
        get: ({
            slotId?: string;
            focused?: number | null;
            submited?: number | null;
    ...
    getOneFeilds<F extends keyof SlotType>(id: import("@reduxjs/toolkit").EntityId, feilds: F[]): (F extends infer T extends keyof SlotType ? { [key in T]: SlotType[F]; } : never) | undefined;
    getAll(): SlotType[];
