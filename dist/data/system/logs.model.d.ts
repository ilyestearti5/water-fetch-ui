...
export declare const logEntity: import("@reduxjs/toolkit").EntityAdapter<Log, import("@reduxjs/toolkit").EntityId>, logSlice: import("@reduxjs/toolkit").Slice<import("@reduxjs/toolkit").EntityState<Log, import("@reduxjs/toolkit").EntityId> & {
    ...
    getOneFeild<F extends keyof Log>(recordId: import("@reduxjs/toolkit").EntityId, feild: F): ({
        logId?: string;
        title: string;
        createdAt?: string;
        showDesc?: boolean;
    ...
    setOneFeild<F extends keyof Log>(id: import("@reduxjs/toolkit").EntityId, feild: F, value: Log[F]): void;
    useOneFeild<F extends keyof Log>(recordeId: import("@reduxjs/toolkit").EntityId, feild: F): {
        get: ({
            logId?: string;
            title: string;
            createdAt?: string;
    ...
    getOneFeilds<F extends keyof Log>(id: import("@reduxjs/toolkit").EntityId, feilds: F[]): (F extends infer T extends keyof Log ? { [key in T]: Log[F]; } : never) | undefined;
    getAll(): Log[];
