...
export declare const colorHooks: {
    ...
    getOneFeild<F extends keyof Color>(recordId: EntityId, feild: F): ({
        colorId: string;
        dark?: string;
        light?: string;
        default?: string;
    ...
    setOneFeild<F extends keyof Color>(id: EntityId, feild: F, value: Color[F]): void;
    useOneFeild<F extends keyof Color>(recordeId: EntityId, feild: F): {
        get: ({
            colorId: string;
            dark?: string;
            light?: string;
    ...
    getOneFeilds<F extends keyof Color>(id: EntityId, feilds: F[]): (F extends infer T extends keyof Color ? { [key in T]: Color[F]; } : never) | undefined;
    getAll(): Color[];
    setAll(data: Record<EntityId, Color> | readonly Color[]): void;
    useAll(): {
        get: Color[];
        set: React.Dispatch<React.SetStateAction<Color[]>>;
    };
