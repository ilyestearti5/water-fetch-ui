...
export declare const initCashing: () => {
    ...
    getOneFeild<F extends keyof Casher>(recordId: import("@reduxjs/toolkit").EntityId, feild: F): ({
        linkId: string;
        response?: string;
        status?: "error" | "success" | "idle";
    }[F] & {}) | undefined;
    setOneFeild<F extends keyof Casher>(id: import("@reduxjs/toolkit").EntityId, feild: F, value: Casher[F]): void;
    useOneFeild<F extends keyof Casher>(recordeId: import("@reduxjs/toolkit").EntityId, feild: F): {
        get: ({
            linkId: string;
            response?: string;
            status?: "error" | "success" | "idle";
    ...
    getOneFeilds<F extends keyof Casher>(id: import("@reduxjs/toolkit").EntityId, feilds: F[]): (F extends infer T extends keyof Casher ? { [key in T]: Casher[F]; } : never) | undefined;
    getAll(): Casher[];
