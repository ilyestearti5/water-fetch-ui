...
export declare const notifayHooks: {
    ...
    getOneFeild<F extends keyof NotificationType>(recordId: import("@reduxjs/toolkit").EntityId, field: F): ({
        id: string;
        title: string;
        type?: "info" | "warning" | "error" | "success";
        desc?: string;
    ...
    setOneFeild<F extends keyof NotificationType>(id: import("@reduxjs/toolkit").EntityId, field: F, value: NotificationType[F]): void;
    useOneFeild<F extends keyof NotificationType>(recordeId: import("@reduxjs/toolkit").EntityId, field: F): {
        get: ({
            id: string;
            title: string;
            type?: "info" | "warning" | "error" | "success";
    ...
    getOneFeilds<F extends keyof NotificationType>(id: import("@reduxjs/toolkit").EntityId, fields: F[]): (F extends infer T extends keyof NotificationType ? { [key in T]: NotificationType[F]; } : never) | undefined;
