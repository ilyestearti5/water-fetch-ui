...
export declare const toastHooks: {
    ...
    getOneFeild<F extends keyof ToastType>(recordId: import("@reduxjs/toolkit").EntityId, field: F): ({
        id?: string;
        message: string | number;
        type?: "info" | "warning" | "error" | "success";
        time?: number;
    }[F] & {}) | undefined;
    setOneFeild<F extends keyof ToastType>(id: import("@reduxjs/toolkit").EntityId, field: F, value: ToastType[F]): void;
    useOneFeild<F extends keyof ToastType>(recordeId: import("@reduxjs/toolkit").EntityId, field: F): {
        get: ({
            id?: string;
            message: string | number;
            type?: "info" | "warning" | "error" | "success";
    ...
    getOneFeilds<F extends keyof ToastType>(id: import("@reduxjs/toolkit").EntityId, fields: F[]): (F extends infer T extends keyof ToastType ? { [key in T]: ToastType[F]; } : never) | undefined;
    getAll(): ToastType[];
