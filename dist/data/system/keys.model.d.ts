...
export declare const init: () => {
    ...
    getOneFeild<F extends keyof Key>(recordId: import("@reduxjs/toolkit").EntityId, field: F): ({
        value?: string;
        keyId?: string;
        command?: Command["commandId"];
        only?: boolean;
    ...
    setOneFeild<F extends keyof Key>(id: import("@reduxjs/toolkit").EntityId, field: F, value: Key[F]): void;
    useOneFeild<F extends keyof Key>(recordeId: import("@reduxjs/toolkit").EntityId, field: F): {
        get: ({
            value?: string;
            keyId?: string;
            command?: Command["commandId"];
    ...
    getOneFeilds<F extends keyof Key>(id: import("@reduxjs/toolkit").EntityId, fields: F[]): (F extends infer T extends keyof Key ? { [key in T]: Key[F]; } : never) | undefined;
    getAll(): Key[];
