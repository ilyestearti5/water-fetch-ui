...
export declare function mergeObject<T extends object | undefined = React.CSSProperties>(...args: (Nothing | T)[]): T;
...
export declare class Shortcut {
    ...
    static fromEvent({ key, ctrlKey: control, shiftKey: shift, altKey: alt }: React.KeyboardEvent<HTMLElement> | KeyboardEvent): string;
    test(e: KeyboardEvent | React.KeyboardEvent<HTMLElement>): boolean;
