...
export declare function ImageChoiser({ onChange, alt, src }: ImageChoiserProps): JSX_2.Element;

declare interface ImageChoiserProps {
    onChange?: (input: ImageParam | null) => void;
    alt?: any;
    src?: ImageParam["dataURL"];
}

export declare function ImageFeild({ state }: ImageFeildProps): JSX_2.Element;

declare type ImageFeildProps = FeildGeneralProps<SettingValueType["image"], SettingConfig["image"]>;

declare type ImageParam = {
    dataURL?: string;
};
...
export declare function PinFeild({ id, config }: PinFeildProps): JSX_2.Element;
...
export declare function Tab({ children, icon, iconClassName, isActive, style, ...props }: TabProps): JSX_2.Element;
...
export declare function TitleView({ title, position: { x, y }, onMouseMove, onMouseLeave, children, canMouseOn, ...props }: TitleViewProps): JSX_2.Element;
