export declare const store: import("@reduxjs/toolkit").EnhancedStore<{
    ...
    fields: import("@reduxjs/toolkit").EntityState<import("@/data/system/field.model").Feild, import("@reduxjs/toolkit").EntityId> & {
        saved: boolean;
        status: string;
        writeStatus: string;
        id: "fieldId";
    ...
    tree: import("@reduxjs/toolkit").EntityState<import("@/data/system/tree.model").TreeType, import("@reduxjs/toolkit").EntityId> & {
        saved: boolean;
        status: string;
        writeStatus: string;
        id: "treeId";
