...
function cr() {
  ...
  function j(h, c, T) {
    ...
    for (p in c)
      m.call(c, p) && !W.hasOwnProperty(p) && (b[p] = c[p]);
    if (h && h.defaultProps)
    ...
    function Ne(e, r, t, n, i) {
      {
        ...
        for (var o in e)
          if (u(e, o)) {
            ...
            a && !(a instanceof Error) && (M(i), l("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, o, typeof a), M(null)), a instanceof Error && !(a.message in de) && (de[a.message] = !0, M(i), l("Failed %s type: %s", t, a.message), M(null));
          }
      }
    }
...
var Q = Z.exports;
const vr = Q.Fragment, pr = Q.jsx, yr = Q.jsxs, br = ({ children: w }) => /* @__PURE__ */ pr(vr, { children: w });
export {
  br as E,
  yr as a,
  pr as j
